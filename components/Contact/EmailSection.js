  ...
  return (
    <section className="EmailSection p-4 py-6  ">
      <div className=" container mx-auto border-b-[1px] border-[#ccc]  ">
        ...
        <div className="grid  pt-[2rem] lg:pt-[5rem] pb-[2rem] px-[2rem]  justify-items-center md:justify-items-center  xl:gap-x-[20rem] gap-x-[5rem]  gap-y-[3rem] grid-cols-1 md:grid-cols-2">
          <div>
            <h1>Email</h1>
